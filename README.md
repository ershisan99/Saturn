...
-   **Animation Control**
    ...
    -   **Keyboard shortcuts:** Press `A` to toggle Remove Animations and `D` to toggle Pause after scoring during a run. A status strip at the left edge of the screen shows the current state of both.
